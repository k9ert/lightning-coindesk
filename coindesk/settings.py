"""
Django settings for coindesk project on Heroku. For more info, see:
...
SECRET_KEY = "!p=_@q37kn3$qysnk_+0zi$8_y&=(#7s5y(z@l^53)i@qx9%!c"
...
WSGI_APPLICATION = 'coindesk.wsgi.application'
...
# Update database configuration with $DATABASE_URL. This is only used for production heroku
